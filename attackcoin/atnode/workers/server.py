from attackcoin.objects.block import Block
from attackcoin.objects.transaction import Transaction
...
from attackcoin.atnode.structures.pool import ObjectNotFound
from attackcoin.atnode.workers.client import Client
...
class Server(Thread):
    ...
    """
    def __init__(self, node: Node, s: ATTACKSocket, allow_swap_roles: bool,
