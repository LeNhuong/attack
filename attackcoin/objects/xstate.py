from attackcoin.globaldef.mining import *
from attackcoin.globaldef.hash import HASH_OF_NULL, HASH_SIZE
from attackcoin.objects.state import State, TransactionError
