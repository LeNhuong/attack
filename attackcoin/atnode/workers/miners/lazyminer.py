from attackcoin.globaldef.hash import HASH_OF_NULL
from attackcoin.objects.block import Block
from attackcoin.objects.transaction import Transaction
from attackcoin.objects.coin import Coin
from attackcoin.objects.state import TransactionError
from attackcoin.objects.xstate import ExtendedState
            ...
            if self.virt_attempt(tmp_block, latest_state.threshold):  # success
                ...
                if self.node.verbose:
                    print("\n({}) Successfully mine a block!".
                          format(height + 1))
                    print("Reward: {} BLC.".format(reward))
