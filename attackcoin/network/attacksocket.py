...
from attackcoin.network.vlp import VLPSocket
from attackcoin.network.protocol import Protocol

from typing import Tuple, Optional


class ATTACKSocket(VLPSocket):
    """A subclass of VLPSocket, adding KMA-Coin objects send/recv functions."""
    @staticmethod
    def from_vlpsocket(vlpsocket: VLPSocket) -> 'ATTACKSocket':
        """Cast a VLP socket to a KMA socket."""
        return ATTACKSocket(vlpsocket.virt_loc, vlpsocket.s,
